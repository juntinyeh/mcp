...
from awslabs.aws_wa_sec_tool_mcp_server.util.prompt_utils import (
...
def reset_prompt_utils_state():
    ...
    from awslabs.aws_wa_sec_tool_mcp_server.util import prompt_utils
...
""")
    ...
    try:
        ...
        with mock.patch(
            "awslabs.aws_wa_sec_tool_mcp_server.util.prompt_utils.load_prompt_templates"
        ) as mock_load:
