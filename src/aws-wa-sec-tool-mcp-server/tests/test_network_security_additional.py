...
from awslabs.aws_wa_sec_tool_mcp_server.util.network_security import (
    check_api_gateway,
...
async def test_check_network_security_with_multiple_services(mock_ctx, mock_boto3_session):
    ...
    with mock.patch(
        "awslabs.aws_wa_sec_tool_mcp_server.util.network_security.find_network_resources"
    ) as mock_find:
        ...
        with (
            mock.patch(
                "awslabs.aws_wa_sec_tool_mcp_server.util.network_security.check_classic_load_balancers"
            ) as mock_check_elb,
            mock.patch(
                "awslabs.aws_wa_sec_tool_mcp_server.util.network_security.check_elbv2_load_balancers"
            ) as mock_check_elbv2,
            mock.patch(
                "awslabs.aws_wa_sec_tool_mcp_server.util.network_security.check_vpc_endpoints"
            ) as mock_check_vpc,
            mock.patch(
                "awslabs.aws_wa_sec_tool_mcp_server.util.network_security.check_security_groups"
            ) as mock_check_sg,
            mock.patch(
                "awslabs.aws_wa_sec_tool_mcp_server.util.network_security.check_api_gateway"
            ) as mock_check_api,
        ):
...
async def test_check_network_security_cloudfront_in_us_east_1(mock_ctx, mock_boto3_session):
    ...
    with mock.patch(
        ...
        with mock.patch(
            "awslabs.aws_wa_sec_tool_mcp_server.util.network_security.check_cloudfront_distributions"
        ) as mock_check_cf:
