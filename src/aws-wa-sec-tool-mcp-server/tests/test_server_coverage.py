...
async def test_initialize():
    ...
    # Since initialize doesn't return anything, we just verify it completes without errors
    # This test is mainly to improve coverage
...
def test_main():
    ...
    with mock.patch("argparse.ArgumentParser") as mock_parser:
        ...
        with mock.patch("asyncio.run") as mock_run:
            # Mock mcp.run
            with mock.patch("awslabs.aws_wa_sec_tool_mcp_server.server.mcp.run") as mock_mcp_run:
