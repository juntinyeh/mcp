...
from awslabs.aws_wa_sec_tool_mcp_server.util.storage_security import (
    _update_results,
    check_s3_buckets,
...
async def test_check_storage_encryption_success(mock_ctx, mock_boto3_session):
    ...
    with mock.patch(
        "awslabs.aws_wa_sec_tool_mcp_server.util.storage_security.find_storage_resources"
    ) as mock_find:
        ...
        with mock.patch(
            "awslabs.aws_wa_sec_tool_mcp_server.util.storage_security.check_s3_buckets"
        ) as mock_check_s3:
