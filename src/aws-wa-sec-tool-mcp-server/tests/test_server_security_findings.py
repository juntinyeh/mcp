...
async def test_get_security_findings_with_service_enabled_in_context(mock_ctx, mock_boto3_session):
    ...
    with mock.patch(
        "awslabs.aws_wa_sec_tool_mcp_server.server.FIELD_SEVERITY_FILTER"
        ...
        with mock.patch(
            "awslabs.aws_wa_sec_tool_mcp_server.server.get_guardduty_findings"
...
async def test_get_security_findings_with_securityhub(mock_ctx, mock_boto3_session):
    ...
    with mock.patch(
        ...
        with mock.patch(
            "awslabs.aws_wa_sec_tool_mcp_server.server.get_securityhub_findings"
        ) as mock_get_findings:
            # Set up mock return value
            mock_get_findings.return_value = {
                "service": "securityhub",
...
async def test_get_security_findings_with_inspector(mock_ctx, mock_boto3_session):
    ...
    with mock.patch(
        ...
        with mock.patch(
            "awslabs.aws_wa_sec_tool_mcp_server.server.get_inspector_findings"
        ) as mock_get_findings:
            # Set up mock return value
            mock_get_findings.return_value = {
                "service": "inspector",
...
async def test_get_security_findings_with_accessanalyzer(mock_ctx, mock_boto3_session):
    ...
    with mock.patch(
        ...
        with mock.patch(
            "awslabs.aws_wa_sec_tool_mcp_server.server.get_access_analyzer_findings"
        ) as mock_get_findings:
            # Set up mock return value
            mock_get_findings.return_value = {
...
async def test_get_security_findings_with_trustedadvisor(mock_ctx, mock_boto3_session):
    ...
    with mock.patch(
        ...
        with mock.patch(
            "awslabs.aws_wa_sec_tool_mcp_server.server.get_trusted_advisor_findings"
        ) as mock_get_findings:
            # Set up mock return value
            mock_get_findings.return_value = {
...
async def test_get_security_findings_with_macie(mock_ctx, mock_boto3_session):
    ...
    with mock.patch(
        ...
        with mock.patch(
            "awslabs.aws_wa_sec_tool_mcp_server.server.get_macie_findings"
        ) as mock_get_findings:
            # Set up mock return value
            mock_get_findings.return_value = {
                "service": "macie",
